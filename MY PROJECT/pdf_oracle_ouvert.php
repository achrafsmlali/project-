...
.aff{width:250px;}
 ...
 <page backtop="12%" backbottom="5%" backimg="bg.png"> 
	<div><?php echo utf8_encode("Tikects  Oracle Ouverts")?></div>
     <table style="width:100%;margin:auto;">
		<tr class="lo">
			...
			<?php
			$que = "SELECT * FROM `table 1` WHERE ((`État` Not Like 'closed') AND (`Brève description` Like '%oracl%' Or `Brève description` Like '%gmao%' Or `Brève description` Like '%jinitiator%')) OR ((`État` Not Like 'closed') AND (`Brève description` Like '%export%' And `Brève description` Like '%pdf%')) OR ((`État` Not Like 'closed') AND (`Brève description` Like '% AP %' Or `Brève description` Like '% FA %' Or `Brève description` Like '% GTA %')) OR ((`État` Not Like 'closed') AND (`Brève description` Like '%GPAO%' Or `Brève description` Like '% INV %' Or `Brève description` Like '% PO %' Or `Brève description` Like '% AR %')) OR ((`État` Not Like 'closed') AND (`Brève description` Like '% EAM %'))";

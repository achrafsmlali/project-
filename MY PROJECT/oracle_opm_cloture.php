...
<html>
	<head>
		<meta  charset="utf-8" /> 
		<title>oracle opm cloture</title>
...
body{
  ...
  background-position: center;
	...
	<body>
		...
		<?php
	echo utf8_encode('<h1 style="text-align:center;">Tickets Oracle OPM cloturé </h1>');
		...
		$req = "SELECT * FROM `table 1` WHERE ((`État` Like 'closed') AND (`Brève description` Like '%opm%' Or `Brève description` Like '%oracl%' Or `Brève description` Like '%gmao%' Or `Brève description` Like '%opm%' Or `Brève description` Like '%saisi%' Or `Brève description` Like '%firewal%' Or `Brève description` Like '%instrumen%' Or `Brève description` Like '%tonnage%')) OR ((`État` Like 'closed') AND (`Brève description` Like '%export%' And `Brève description` Like '%pdf%')) OR ((`État` Like 'closed') AND (`Brève description` Like '%formule%' Or `Brève description` Like '%bascule%' Or `Brève description` Like '%opm%' Or `Brève description` Like '%capteur%')) OR ((`État` Like 'closed') AND (`Brève description` Like '%étalonnage%' Or `Brève description` Like '%compteur%' Or `Brève description` Like '%remontée%')) OR ((`État` Like 'closed') AND (`Brève description` Like '%débimètre%' Or `Brève description` Like '%automate%' Or `Brève description` Like '% tag %' Or `Brève description` Like '%jinitiator%')) OR ((`État` Like 'closed') AND (`Brève description` Like '%capteur%' Or `Brève description` Like '%forçage%' Or `Brève description` Like '% AP %' Or `Brève description` Like '% FA %' Or `Brève description` Like '% GTA %')) OR ((`État` Like 'closed') AND (`Brève description` Like '%écart%' Or `Brève description` Like '%coefficient%' Or `Brève description` Like '%GPAO%' Or `Brève description` Like '% INV %' Or `Brève description` Like '% PO %' Or `Brève description` Like '% AR %')) OR ((`État` Like 'closed') AND (`Brève description` Like 'formation%' Or `Brève description` Like '%débimètre%' Or `Brève description` Like '% EAM %' Or `Brève description` Like '%rapport%' Or `Brève description` Like '%instrument%')) OR ((`État` Like 'closed') AND (`Brève description` Like '%opc%' Or `Brève description` Like '%NACHA%' Or `Brève description` Like '%NAEPI%' Or `Brève description` Like '%NALAV%' Or `Brève description` Like '%NACA%' Or `Brève description` Like '%NAC%' Or `Brève description` Like '%NASE%' Or `Brève description` Like '%NAGEF%' Or `Brève description` Like '%NAGEFL%' Or `Brève description` Like '% PB-GA%'))";
		...
		/*..*/if($records_count != 0){
		/*..*/$que = "SELECT * FROM `table 1` WHERE ((`État` Like 'closed') AND (`Brève description` Like '%opm%' Or `Brève description` Like '%oracl%' Or `Brève description` Like '%gmao%' Or `Brève description` Like '%opm%' Or `Brève description` Like '%saisi%' Or `Brève description` Like '%firewal%' Or `Brève description` Like '%instrumen%' Or `Brève description` Like '%tonnage%')) OR ((`État` Like 'closed') AND (`Brève description` Like '%export%' And `Brève description` Like '%pdf%')) OR ((`État` Like 'closed') AND (`Brève description` Like '%formule%' Or `Brève description` Like '%bascule%' Or `Brève description` Like '%opm%' Or `Brève description` Like '%capteur%')) OR ((`État` Like 'closed') AND (`Brève description` Like '%étalonnage%' Or `Brève description` Like '%compteur%' Or `Brève description` Like '%remontée%')) OR ((`État` Like 'closed') AND (`Brève description` Like '%débimètre%' Or `Brève description` Like '%automate%' Or `Brève description` Like '% tag %' Or `Brève description` Like '%jinitiator%')) OR ((`État` Like 'closed') AND (`Brève description` Like '%capteur%' Or `Brève description` Like '%forçage%' Or `Brève description` Like '% AP %' Or `Brève description` Like '% FA %' Or `Brève description` Like '% GTA %')) OR ((`État` Like 'closed') AND (`Brève description` Like '%écart%' Or `Brève description` Like '%coefficient%' Or `Brève description` Like '%GPAO%' Or `Brève description` Like '% INV %' Or `Brève description` Like '% PO %' Or `Brève description` Like '% AR %')) OR ((`État` Like 'closed') AND (`Brève description` Like 'formation%' Or `Brève description` Like '%débimètre%' Or `Brève description` Like '% EAM %' Or `Brève description` Like '%rapport%' Or `Brève description` Like '%instrument%')) OR ((`État` Like 'closed') AND (`Brève description` Like '%opc%' Or `Brève description` Like '%NACHA%' Or `Brève description` Like '%NAEPI%' Or `Brève description` Like '%NALAV%' Or `Brève description` Like '%NACA%' Or `Brève description` Like '%NAC%' Or `Brève description` Like '%NASE%' Or `Brève description` Like '%NAGEF%' Or `Brève description` Like '%NAGEFL%' Or `Brève description` Like '% PB-GA%'))LIMIT $start,$end";
		...
		?>	
			...
			/*..*/		echo $page;
			/*..*/	else 
			/*..*/		echo '<a href ="oracle_opm_cloture.php?page=' . $x . '">' . $x . '</a>';
			/*..*/	echo"</td>";
			/*..*/		}}

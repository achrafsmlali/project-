...
body{
  ...
  background-position: center;
	...
	<body>
		...
		<?php
	echo utf8_encode('<h1 style="text-align:center;">Tickets oracle cloturé </h1>');
		...
		$req = "SELECT * FROM `table 1`WHERE ((`État` Like 'closed') AND (`Brève description` Like '%oracl%' Or `Brève description` Like '%gmao%' Or `Brève description` Like '%jinitiator%')) OR ((`État` Like 'closed') AND (`Brève description` Like '% AP %' Or `Brève description` Like '% FA %' Or `Brève description` Like '% GTA %')) OR ((`État` Like 'closed') AND (`Brève description` Like '%GPAO%' Or `Brève description` Like '% INV %' Or `Brève description` Like '% PO %' Or `Brève description` Like '% AR %')) OR ((`État` Like 'closed') AND (`Brève description` Like '% EAM %'))";
		...
		/*..*/if($records_count != 0){
		/*..*/$que = "SELECT * FROM `table 1`WHERE ((`État` Like 'closed') AND (`Brève description` Like '%oracl%' Or `Brève description` Like '%gmao%' Or `Brève description` Like '%jinitiator%')) OR ((`État` Like 'closed') AND (`Brève description` Like '% AP %' Or `Brève description` Like '% FA %' Or `Brève description` Like '% GTA %')) OR ((`État` Like 'closed') AND (`Brève description` Like '%GPAO%' Or `Brève description` Like '% INV %' Or `Brève description` Like '% PO %' Or `Brève description` Like '% AR %')) OR ((`État` Like 'closed') AND (`Brève description` Like '% EAM %'))LIMIT $start,$end";
